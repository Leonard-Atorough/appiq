...
export const Variants: Story = {
  render: () => (
    <div className="space-y-4">
      <div>
        <h3 className="mb-2 text-sm font-medium text-primary">Text Skeleton</h3>
        <SkeletonText />
      </div>
      <div>
        <h3 className="mb-2 text-sm font-medium text-primary">Avatar Skeleton</h3>
        <SkeletonAvatar />
      </div>
      <div>
        <h3 className="mb-2 text-sm font-medium text-primary">Image Skeleton</h3>
        <SkeletonImage aspectRatio="video" />
      </div>
      <div>
        <h3 className="mb-2 text-sm font-medium text-primary">Icon Skeleton</h3>
        <SkeletonIcon />
      </div>
    </div>
  ),
...
export const Sizes: Story = {
  render: () => (
    <div className="space-y-4">
      <div>
        <h3 className="mb-2 text-sm font-medium text-primary">Text Sizes</h3>
      ...
      <div>
        <h3 className="mb-2 text-sm font-medium text-primary">Avatar Sizes</h3>
      ...
      <div>
        <h3 className="mb-2 text-sm font-medium text-primary">Icon Sizes</h3>
        <div className="flex gap-4">
...
export const AvatarShapes: Story = {
  render: () => (
    <div className="space-y-4">
      <div>
        <h3 className="mb-2 text-sm font-medium text-primary">Circle (default)</h3>
        <SkeletonAvatar shape="circle" size="lg" />
      </div>
      <div>
        <h3 className="mb-2 text-sm font-medium text-primary">Square</h3>
...
export const ImageAspectRatios: Story = {
  render: () => (
    <div className="space-y-4">
      <div>
        <h3 className="mb-2 text-sm font-medium text-primary">Square (1:1)</h3>
        <SkeletonImage aspectRatio="square" width="200px" />
      </div>
      <div>
        <h3 className="mb-2 text-sm font-medium text-primary">Video (16:9)</h3>
        <SkeletonImage aspectRatio="video" width="100%" />
      </div>
      <div>
        <h3 className="mb-2 text-sm font-medium text-primary">Landscape (4:3)</h3>
        <SkeletonImage aspectRatio="landscape" width="100%" />
      </div>
      <div>
        <h3 className="mb-2 text-sm font-medium text-primary">Portrait (3:2)</h3>
...
export const AnimationToggle: Story = {
  render: () => (
    <div className="space-y-4">
      <div>
        <h3 className="mb-2 text-sm font-medium text-primary">Animated (default)</h3>
        <SkeletonText animated={true} />
      </div>
      <div>
        <h3 className="mb-2 text-sm font-medium text-primary">Static (animated=false)</h3>
...
export const ComposedCard: Story = {
  render: () => (
    <div className="space-y-4">
      <div>
        <h3 className="mb-2 text-sm font-medium text-primary">Basic Card (3 lines)</h3>
        <SkeletonCard />
      </div>
      <div>
        <h3 className="mb-2 text-sm font-medium text-primary">Card with Header</h3>
        <SkeletonCard withHeader />
      </div>
      <div>
        <h3 className="mb-2 text-sm font-medium text-primary">Card with Header & Footer</h3>
        <SkeletonCard withHeader withFooter />
      </div>
      <div>
        <h3 className="mb-2 text-sm font-medium text-primary">Card with Many Lines</h3>
...
export const ComposedTableRow: Story = {
  render: () => (
    <div className="space-y-4">
      <div>
        <h3 className="mb-2 text-sm font-medium text-primary">4 Columns</h3>
        <SkeletonTableRow columns={4} />
      </div>
      <div>
        <h3 className="mb-2 text-sm font-medium text-primary">Variable Column Sizes</h3>
        <SkeletonTableRow columns={["sm", "md", "lg", "md"]} />
      </div>
      <div>
        <h3 className="mb-2 text-sm font-medium text-primary">Multiple Rows</h3>
...
export const ComposedField: Story = {
  render: () => (
    <div className="space-y-4">
      <div>
        <h3 className="mb-2 text-sm font-medium text-primary">Basic Field (label + input)</h3>
        <SkeletonField />
      </div>
      <div>
        <h3 className="mb-2 text-sm font-medium text-primary">Field with Helper Text</h3>
        <SkeletonField withHelper />
      </div>
      <div>
        <h3 className="mb-2 text-sm font-medium text-primary">Input Only</h3>
        <SkeletonField withLabel={false} />
      </div>
      <div>
        <h3 className="mb-2 text-sm font-medium text-primary">Multiple Fields</h3>
        ...
        <div className="rounded-lg border border-base bg-(--color-surface) p-4">
          {isLoading ? (
            ...
            <div className="space-y-3">
              ...
              />
              <h3 className="text-lg font-semibold text-primary">Real Content Loaded</h3>
