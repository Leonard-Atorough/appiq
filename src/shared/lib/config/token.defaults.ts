import type { ThemeConfig } from "../createTheme";

/**
 * Default theme preset for AppIQ UI Library
 *
 * Defines the complete default token system extracted from the design tokens.
 * All values are expressed in their final form (no CSS variable references).
 * Consumers can override any subset of these tokens via `createTheme()`.
 */
